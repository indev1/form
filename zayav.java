...
JLabel серия = new JLabel("\u0441\u0435\u0440\u0438\u044F");
серия.setFont(new Font("Dialog", Font.PLAIN, 10));
серия.setBounds(69, 269, 56, 16);
frame.getContentPane().add(серия);
...
public void actionPerformed(ActionEvent e) {
	...
	if (V2Brak.isSelected()){
		sempol = "Состою в повторном браке";
...
public void actionPerformed(ActionEvent e) {
	...
	if (pol!= null) {
	if (pol.equals("Женский"))
	q = q + 0.4 ;
	}
	

if(bank != null && bank != "Не имеется") {
	q = q + 0.45;
}
...
if (kukuha != null) {
	 if (kukuha.equals("Металлургия") || kukuha.equals("Логистика") || kukuha.equals("Транспорт") || kukuha.equals("Строительство") || kukuha.equals("Нефтегазовая промышленность") ) 
		q = q + 0.0; }
		else {
			q = q + 0.55;
		}
...
if (kv!=null) {
if(kv.equals("Единоличная собственность") || dom.equals("Единоличная собственность") || avto.equals("Единоличная собственность") ) 
	q = q + 0.35;
}

if(strahpol!=null) {
if (strahpol.equals("Имею")) 
	q = q + 0.19; 
}
...
if (q<= 1.25) {
	JOptionPane.showMessageDialog(null, "Ваше заявление не прошло проверку на платёжеспособность.");
...
Sobst.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		if (Sobst.isSelected()) {
			...
			avto = "Единоличная собственность";
